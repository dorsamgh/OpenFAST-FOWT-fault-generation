...
The full simulation dataset generated using this code — covering all 11 operating classes (1 healthy + 10 faulted, across the severity levels above) and 12 turbulent wind speed conditions per class — is archived on Zenodo:
...
A manuscript describing the fault diagnosis method developed using this dataset is currently under review at *Renewable Energy* (Elsevier). This section will be updated with the full citation and link once the paper is published.
